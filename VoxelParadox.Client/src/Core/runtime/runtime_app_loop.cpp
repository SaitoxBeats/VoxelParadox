...
#include "runtime_app_death_sequence.hpp"
#include "runtime_app_loop_shared.hpp"
#include "runtime_app_screenshot.hpp"
...
#pragma region 1. Core Frame Routines
    ...
    void updateGame(Player& player, WorldStack& worldStack,
        ...
        hudPortalTracker* portalTracker, const GameChat& gameChat,
