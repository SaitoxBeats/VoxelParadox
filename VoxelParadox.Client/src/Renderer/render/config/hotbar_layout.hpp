// Arquivo: VoxelParadox.Client/src/Renderer/render/config/hotbar_layout.hpp
...
struct HotbarHUDLayout {
    ...
    int experienceBarHeight = 20;
    int experienceBarGap = 4;
    int experienceBarBorderThickness = 2;
    int experienceBarFillInset = 0;
    glm::ivec2 lifeLabelTextOffset{6, -3};
    glm::ivec2 experienceLabelTextOffset{6, -3};
    glm::ivec2 experienceLevelTextOffset{46, -3};
    glm::vec2 experienceTextScale{1.0f, 1.0f};
    int experienceTextFontSize = 18;
    int portalCooldownHorizontalOffset = 52;
...
inline glm::ivec2 resolveHotbarExperienceBarSize(const HotbarHUDLayout& layout) {
    return glm::ivec2(
        resolveHotbarLifeBarWidth(layout),
        layout.experienceBarHeight
    );
}
