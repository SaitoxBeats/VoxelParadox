// Arquivo: VoxelParadox.Client/src/Renderer/render/config/hotbar_preview_config.hpp
...
#include "render/config/hotbar_layout.hpp"
#include "render/hud/styles/hotbar_hud_style.hpp"
